...
namespace GHSynth.Audio
{
	public class ProjectSettingsComponent : GH_Component
	{
		...
		{
			DA.SetData(0, GHSynthSettings.SampleRate);
			DA.SetData(1, GHSynthSettings.TimeScale);
			DA.SetData(2, GHSynthSettings.AmplitudeScale);
			DA.SetData(3, GHSynthSettings.Tempo);
		}
